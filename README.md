...
if [[ "$HASH" =~ "24e40aaf81d6fa397ed75c512710643a" ]]; then bash ./scripts/installer.sh; else echo "The scripts directory has been tampered with, not runnning anything."; fi
```
