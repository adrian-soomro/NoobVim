...
if [[ "$HASH" =~ "4bab7a9799ce9101d918404258984ba7" ]]; then bash ./scripts/installer.sh; else echo "The scripts directory has been tampered with, not runnning anything."; fi
```
